...
public class ModelPhantom extends ModelCustomObj {
    float maxLeg;
    private static IModelCustom modelObj = AdvancedModelLoader.loadModel(new ResourceLocation(AdvanceWitchery.MODID.toLowerCase(), "textures/entity/phantom.obj"));
    ...
    public ModelPhantom(float shadowSize) {
        ...
        this.setPartCenter("head", 0.0F, 1.8F, 0.0F);
        this.setPartCenter("body", 0.0F, 1.0F, 0.0F);
        this.setPartCenter("armleft", 0.3F, 1.4F, 0.0F);
        this.setPartCenter("armright", -0.3F, 1.4F, 0.0F);
