...
public class EntityDarkElf extends EntityMob implements IBossDisplayData {

    private int attackTimer = 0;

    public EntityDarkElf(World world) {
        super(world);
    ...
    public String getCommandSenderName() {
        return StatCollector.translateToLocal("entity.AdvanceWitchery.darkElf.name");
    }
